    ...
    <section class="w-full bg-[#12141B] max-w-[1600px] mx-auto flex">
        ...
        <div class="h-screen overflow-hidden w-full">
            ...
            <div class="bg-[#262B3A] flex justify-between items-center py-3 px-10">
                ...
                <input type="text" name="" id="searchAllCustomers" class="w-[800px] py-2 px-5 rounded outline-none" placeholder="Search by name">
            </div>
            <!-- Search End-->
            ...
            <div class="px-[53px] py-8">
                ...
                <div class="flex items-center justify-end space-x-2 mb-2">
                    ...
                    <select name="" id="dropdownAllCustomer" class="outline-none rounded py-1 px-3">
                        ...
                        <div class="h-[600px] overflow-y-scroll scrollbar-hide">
                            <table class="table text-textBlack border-separate space-y-6 text-sm w-[1200px] overflow-y-scroll">
                                ...
                                <tbody class="searchResult">
                                    <?php $num = 1; ?>
                                    <?php foreach ($allCustomersList as $allCustomer) { ?>
                                        <tr class="bg-[#fffafa]">
                                            <td class="p-3 text-center"><?= $num++; ?></td>
                                            <td class="p-3 text-center"><?= $allCustomer["c_name"] ?></td>
                                            <td class="p-3 text-center"><?= $allCustomer["c_email"] ?></td>
                                            <td class="p-3 text-center"><?= $allCustomer["c_phone"] ?></td>
                                            <td class="p-3 text-center"><?= $allCustomer["c_address"] ?></td>
                                            <td class="p-3 text-center"><?= $allCustomer["create_date"] ?></td>
                                            <td class="p-3 text-center ">
                                                <?php $cName = $allCustomer["c_name"] ?>
                                                <?php $cEmail = $allCustomer["c_email"] ?>
                        ...
                        <form action="../../Controller/customersList/banCustomerController.php" method="post">
                            <div class="mt-3 ml-4 text-left">
                                ...
                                <div class="flex justify-center space-x-4 mt-6">
                                    ...
                                    <button type="submit" name="allCustomer" class="closeBanModal bg-[#396C21] rounded-[5px] px-3 py-1 text-white">Confirm</button>
                                </div>
                            </div>
                        </form>
                    </div>
