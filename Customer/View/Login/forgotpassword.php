...
<body class="bg-[<?php
    ...
    <div class="bg-[<?php
        ...
        <p class="mt-4 text-xs md:text-base text-center absolute right-5 top-2">
            <a href="./login.php"><button class="bg-tertiary  text-xs md:text-sm md:w-20 p-1 
            bg-[<?php
    ...
    <div class="flex justify-center items-center flex-col px-5">
        ...
        <div class="bg-primary relative md:w-1/2 flex justify-center items-center  shadow-2xl md:mt-5 mt-10  py-8">
            <div class="hidden md:block w-1/2 p-8 mt-10 mb-10">
                <img src="../resources/img/login/forgot_password.png" alt="Illustration Photo" class="w-full h-full object-cover">
            </div>
            <div class="p-8 md:w-1/2 text-center">
                ...
                <form action="../../Controller/forgotPasswordController.php" method="post">
                    <input type="email" name="email" placeholder="Email" required class="w-full py-1 md:py-2 px-3 rounded border 
                    border-[<?php
                    ...
                    <button type="submit" name="forgotPw" class="w-full py-1 mt-3 md:py-2 px-4 text-sm md:text-base 
                    bg-[<?php
                        ...
                        ?>] 
             text-white rounded  focus:outline-none focus:ring-2">Reset Password</button>
                </form>
            </div>
        </div>
    </div>
